...
export default function RootLayout({
            ...
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
              ...
              <div className="flex items-center gap-6">
                ...
                {clerkKey ? (
                  ...
                  <span className="text-[8px] font-black text-red-500 uppercase tracking-widest border border-red-500/20 px-2 py-1 rounded">Auth_Offline</span>
                )}
  ...
  // CRITICAL FIX: Only wrap in ClerkProvider if the key exists to prevent Digest crashes
  return clerkKey ? (
