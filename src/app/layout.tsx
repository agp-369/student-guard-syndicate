  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className={inter.className}>
        ...
        >
          <header className="fixed top-0 left-0 w-full z-[100] bg-background/80 backdrop-blur-xl border-b border-white/5">
...
function NavLink({ href, label, icon }: { href: string, label: string, icon: React.ReactNode }) {
  return (
    <Link 
      href={href} 
      className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 hover:text-foreground transition-all group"
    >
